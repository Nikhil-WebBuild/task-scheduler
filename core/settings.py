...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-9ws^!ptqd)tahwcamesd5p*dh+kdg0d3k!8f7var9-$g=@&*_$')

# SECURITY WARNING: don't run with debug turned on in production!
# Set DEBUG = False for production to prevent exposing sensitive error information.
DEBUG = os.environ.get('DEBUG', 'False').lower() == 'true'

# Allowed hosts must be configured in production to prevent HTTP Host header attacks.
